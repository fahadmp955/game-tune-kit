...
export const CatalogPage: React.FC<CatalogPageProps> = ({ onSelectUtility, selectedFamily, onSelectFamily }) => {
  ...
  const utilities: UtilityMeta[] = [
    ...
    {
      id: '30-k-factor-calculator',
      code: '30',
      name: 'Paid to Organic K-Factor Spillage',
      family: 'growth-ua',
      description: 'Model organic viral spillage multipliers from paid UA campaigns and effective CPI discounts.',
      isCore: true,
      tagText: 'Growth & UA',
      tagColor: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20',
    },
    {
      id: '31-att-dilution-calculator',
      code: '31',
      name: 'ATT Privacy Signal Dilution',
      family: 'growth-ua',
      description: 'Evaluate iOS ATT consent opt-in rates, signal loss, and estimated UA ROAS efficiency degradation.',
      isCore: true,
      tagText: 'Growth & UA',
      tagColor: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20',
    },
    {
      id: '24-ad-yield-optimizer',
      code: '24',
      name: 'Ad Revenue Yield Optimizer',
      family: 'growth-ua',
      description: 'Calculate daily and annual revenue uplift from eCPM floor price optimization across ad networks.',
      isCore: true,
      tagText: 'Growth & UA',
      tagColor: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20',
    },
    {
      id: '25-mediation-latency-calculator',
      code: '25',
      name: 'Mediation Latency Yield Leakage',
      family: 'growth-ua',
      description: 'Quantify ad revenue lost to waterfall response latency timeouts and impression drop-off rates.',
      isCore: true,
      tagText: 'Growth & UA',
      tagColor: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20',
    },
    {
      id: '29-kpi-tree-calculator',
      code: '29',
      name: 'KPI Tree Leverage Calculator',
      family: 'intelligence-metrics',
      description: 'Model compounding revenue leverage from retention improvements vs baseline ARPDAU and DAU.',
      isCore: true,
      tagText: 'Intelligence',
      tagColor: 'bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20',
    },
    {
      id: '28-whale-ab-test-calculator',
      code: '28',
      name: 'Whale-Skewed A/B Test',
      family: 'data-experimentation',
      description: 'Detect whale outlier frequency in sample sizes and evaluate skew impact on experiment conclusions.',
      isCore: true,
      tagText: 'Data & A/B',
      tagColor: 'bg-sky-500/10 text-sky-600 dark:text-sky-400 border-sky-500/20',
    },
    {
      id: '06-retention-benchmark-calculator',
      code: '06',
      name: 'Retention Curve Benchmark',
      family: 'intelligence-metrics',
      description: 'Compare observed D1 and D7 retention metrics against genre P50/P75 benchmarks.',
      isCore: true,
      tagText: 'Intelligence',
      tagColor: 'bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20',
    },
    {
      id: '19-liveops-season-impact',
      code: '19',
      name: 'LiveOps Event Season Impact',
      family: 'liveops',
      description: 'Model incremental revenue uplift and total season earnings from battle pass and seasonal event campaigns.',
      isCore: true,
      tagText: 'LiveOps',
      tagColor: 'bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20',
    },
